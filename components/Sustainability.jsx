          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[1px] bg-[#dcdfe4]">
            {sustainabilityItems.map((item, idx) => (
              <div key={idx} className="flex flex-col items-center group" style={{
                ...
                {/* Icon */}
                <div className="w-[80px] h-[80px] rounded-full flex items-center justify-center mb-6 text-white group-hover:scale-105 transition-transform duration-300" style={{ background: '#F7A800' }}>
